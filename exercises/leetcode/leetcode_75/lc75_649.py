...
Announce the victory: If this senator found the senators 
...
The round-based procedure starts from the first senator 
to the last senator in the given order. This procedure 
will last until the end of voting. 
    ...
    def predictPartyVictory(self, senate):
        ...
        while radiant_queue and dire_queue:
            ...
            if radiant_index < dire_index:
                radiant_queue.append(radiant_index+senator_count)
            else:
                dire_queue.append(dire_index+senator_count)
